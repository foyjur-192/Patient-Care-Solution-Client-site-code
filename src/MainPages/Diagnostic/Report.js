                ...
                <div class="modal-box">
                   ...
                   <h2 className='text-2xl mb-5'>Delivery the Report</h2>
                    <form onSubmit={handleBooking}>
                        ...
                        <input type="text" name='patientEmail' value={patientEmail} class="mb-2 input input-bordered w-full max-w-xs " />
                        <input type="email" name='doctorEmail' value={doctorEmail} class="mb-2 input input-bordered w-full max-w-xs " />
